...
const translations = {
  fr: {
    ...
    forWho1Title: "Événement de grande envergure",
    ...
    why5Desc: "Lancement possible en 48h, un résultat toujours parfait même sur des délais courts.",
    ...
    formEventOptSoireeB2B: "Soirée B2B",
    formEventOptCocktailDinatoire: "Cocktail dînatoire",
    formEventOptCocktailDejeunatoire: "Cocktail déjeunatoire",
    formEventOptPetitsDejeuners: "Petits déjeuners",
    formEventOptEventCatering: "Event catering",
    formEventOptLivraisonRepas: "Livraison de repas",
    formEventOptSoireeTheme: "Soirée à thème",
    formEventOptAutre: "Autre",
    ...
    formSvcSoireeB2B: "Soirée B2B",
    formSvcCocktailDinatoire: "Cocktail dînatoire",
    formSvcCocktailDejeunatoire: "Cocktail déjeunatoire",
    formSvcPetitsDejeuners: "Petits déjeuners",
    formSvcEventCatering: "Event catering",
    formSvcLivraisonRepas: "Livraison de repas",
    formSvcSoireeTheme: "Soirée à thème",
    formSvcAutre: "Autre",
  ...
  en: {
    ...
    forWho1Title: "Large-scale events",
    ...
    why5Desc: "Launch possible in 48h — flawless results even on tight deadlines.",
    ...
    formEventOptSoireeB2B: "B2B event",
    formEventOptCocktailDinatoire: "Cocktail reception (evening)",
    formEventOptCocktailDejeunatoire: "Cocktail reception (lunch)",
    formEventOptPetitsDejeuners: "Breakfast",
    formEventOptEventCatering: "Event catering",
    formEventOptLivraisonRepas: "Meal delivery",
    formEventOptSoireeTheme: "Themed event",
    formEventOptAutre: "Other",
    ...
    formSvcSoireeB2B: "B2B event",
    formSvcCocktailDinatoire: "Cocktail reception (evening)",
    formSvcCocktailDejeunatoire: "Cocktail reception (lunch)",
    formSvcPetitsDejeuners: "Breakfast",
    formSvcEventCatering: "Event catering",
    formSvcLivraisonRepas: "Meal delivery",
    formSvcSoireeTheme: "Themed event",
    formSvcAutre: "Other",
